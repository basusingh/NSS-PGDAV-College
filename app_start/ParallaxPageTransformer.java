...
/**
 * Created by Basu Singh on 11/4/2016.
 */
...
class ParallaxPageTransformer implements ViewPager.PageTransformer {
    ...
    public void applyParallaxEffect(View view, float position, int pageWidth,
    ...
    public static class ParallaxTransformInformation {
        ...
        public static final float PARALLAX_EXIT_SLOW = -20f;
        public static final float PARALLAX_EXIT_MEDIUM = -50f;
        public static final float PARALLAX_EXIT_HIGH = -90f;
        public static final float PARALLAX_EFFECT_DEFAULT = -20.1986f;
